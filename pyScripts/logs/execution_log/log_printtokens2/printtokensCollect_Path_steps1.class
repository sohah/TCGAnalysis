...
public class tcgbenchmarks_printtokens2_3_printTokens2Test {
	...
	@Test
	public void test18() {
		tcgbenchmarks_printtokens2_3_printtokens2.mainProcess('C','b','c','d','e','f','g','h');
	}

	@Test
	public void test19() {
		tcgbenchmarks_printtokens2_3_printtokens2.mainProcess('e','b','c','d','e','f','g','h');
	}

	@Test
	public void test20() {
		tcgbenchmarks_printtokens2_3_printtokens2.mainProcess('뀿','b','c','d','e','f','g','h');
	}
	...
	@Test
	public void test25() {
		tcgbenchmarks_printtokens2_3_printtokens2.mainProcess('\b','b','c','d','e','f','g','h');
	}
}
